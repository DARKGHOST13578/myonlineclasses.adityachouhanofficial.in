...
//SUNDAY
 if (dayOfWeekNumber == 0) {
    let x = "NO CLASS TODAY BUT CLICK ON THIS TO ENJOY"
...
//TUTION 1
if (hours == 5 && minutes > 29) {
    let x = "TUTION CLASS STARTED CLICK ON THIS NOTIFICATION TO JOIN"
...
//SCHOOL
    ...
    let x = "HINDI CLASS STARTED CLICK ON THIS NOTIFICATION TO JOIN"
    ...
    let x = "SCIENCE CLASS STARTED CLICK ON THIS NOTIFICATION TO JOIN"
    ...
    let x = "MATHS CLASS STARTED CLICK ON THIS NOTIFICATION TO JOIN"
    ...
    let x = "TELUGU CLASS STARTED CLICK ON THIS NOTIFICATION TO JOIN"
    ...
    let x = "SOCIAL CLASS STARTED CLICK ON THIS NOTIFICATION TO JOIN"
    ...
    let x = "ENGLISH CLASS STARTED CLICK ON THIS NOTIFICATION TO JOIN"
    ...
    let x = "IIT PHYSICS CLASS STARTED CLICK ON THIS NOTIFICATION TO JOIN"
    ...
    let x = "IIT MATHS CLASS STARTED CLICK ON THIS NOTIFICATION TO JOIN"
